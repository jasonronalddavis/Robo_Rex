...
// These are *logical ServoBus channels* (0-15), not raw GPIO pins.
// Channels 6-15 are mapped to GPIO 7,10,35-42 in ServoBus.h.
struct Map {
  // Right leg servos (5 servos) - channels 6-10
  uint8_t R_hipX   = 6;   // channel 6  - Right hip forward/back (GPIO 7)
  uint8_t R_hipY   = 7;   // channel 7  - Right hip up/down   (GPIO 10)
  uint8_t R_knee   = 8;   // channel 8  - Right knee bend     (GPIO 35)
  uint8_t R_ankle  = 9;   // channel 9  - Right ankle pivot   (GPIO 36)
  uint8_t R_foot   = 10;  // channel 10 - Right foot tilt     (GPIO 37)
  
  // Left leg servos (5 servos) - channels 11-15
  uint8_t L_hipX   = 11;  // channel 11 - Left hip forward/back (GPIO 38)
  uint8_t L_hipY   = 12;  // channel 12 - Left hip up/down     (GPIO 39)
  uint8_t L_knee   = 13;  // channel 13 - Left knee bend       (GPIO 40)
  uint8_t L_ankle  = 14;  // channel 14 - Left ankle pivot     (GPIO 41)
  uint8_t L_foot   = 15;  // channel 15 - Left foot tilt       (GPIO 42)
};
